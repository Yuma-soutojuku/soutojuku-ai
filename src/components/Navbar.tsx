        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              {/* ▼ 採用情報へのリンクを追加 ▼ */}
              <Link href="/recruitment" className="text-slate-600 hover:text-emerald-600 px-3 py-2 rounded-full text-sm font-bold transition-colors flex items-center">
                <Briefcase size={16} className="mr-1 text-blue-400" />
                採用情報
              </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-emerald-100 shadow-lg">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            {/* ▼ スマホ用メニューにも採用情報を追加 ▼ */}
            <Link href="/recruitment" className="text-slate-700 block px-4 py-3 rounded-2xl text-base font-bold hover:bg-emerald-50 flex items-center">
